...
function AboutPage() {
  return (
    <div className="min-h-screen bg-nouriva-cream text-nouriva-charcoal px-6 py-10 space-y-12">
        {/* 🖼️ Hero Image */}
        <img
      ...
      <section className="text-center">
        <h1 className="text-4xl font-bold text-nouriva-green mb-2">About Nouriva</h1>
      ...
      <section className="bg-white rounded-xl p-6 shadow-md max-w-4xl mx-auto">
        <h2 className="text-2xl font-semibold text-nouriva-green mb-4">Our Philosophy</h2>
      ...
      <section className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        <div className="bg-white rounded-lg p-5 shadow">
          <h3 className="text-xl font-semibold text-nouriva-green mb-2">Protein</h3>
          <p className="text-gray-700 text-sm">
            Protein-rich foods support muscle repair, hormone balance, and long-lasting energy. Choose lean meats, fish, eggs, legumes, tofu, or yogurt, and aim to include protein in every meal.
          </p>
        </div>
        <div className="bg-white rounded-lg p-5 shadow">
          <h3 className="text-xl font-semibold text-nouriva-green mb-2">Healthy Fats</h3>
          <p className="text-gray-700 text-sm">
        ...
        <div className="bg-white rounded-lg p-5 shadow">
          <h3 className="text-xl font-semibold text-nouriva-green mb-2">Vegetables</h3>
          <p className="text-gray-700 text-sm">
      ...
      {/* 4. Tips & Resources */}
      <section className="bg-white rounded-xl p-6 shadow-md max-w-4xl mx-auto">
        <h2 className="text-2xl font-semibold text-nouriva-green mb-4">Tips for Nourishing Meals</h2>
        <ul className="list-disc list-inside space-y-2 text-gray-700 text-sm">
          ...
          <li>Cook at home when possible to control ingredients and save money.</li>
          <li>Listen to your body's hunger and fullness cues.</li>
        </ul>
        <p className="mt-4 text-sm text-gray-500 italic">
          Source: <a href="https://food-guide.canada.ca/en/tips-for-healthy-eating/adults/" target="_blank" rel="noopener noreferrer" className="text-nouriva-green underline">Canada’s Food Guide – Tips for Healthy Eating</a>
        </p>
      </section>
